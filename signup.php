...
<body>
    <div class="container">
        <form action="process\signup-process.php" method="post">
            <div class="row justify-content-md-center">
                <div class="col-6">
                    ...
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control" id="floatingInput" placeholder="Create a password"
                            name="pass1" required>
        ...
        <p style="text-align: center;">Already Have An Account? <span><a href="login.php">Login Here</a></span> OR,
